...
HEADERS = SimpleFileReader.h BufferedFileReader.h BufferChecker.h
TESTOBJS = test_simplefilereader.o test_bufferedfilereader.o test_performance.o test_suite.o
